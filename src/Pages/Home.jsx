...
const WORDS = ["MERN Stack Developer", "AWS & Web3 Enthusiast"];
const TECH_STACK = ["React.js", "Next.js", "Node.js", "Express.js", "MongoDB", "AWS", "Web3"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/monuprajapat" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/monuprajapat/" },
  { icon: Instagram, link: "https://www.instagram.com/monu__prajapat/" },
];
...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-[#030014] overflow-hidden" id="Home">
      ...
      >
        <div className="container mx-auto px-[5%] sm:px-6 lg:px-[0%] min-h-screen pt-24 sm:pt-28 md:pt-24 lg:pt-12">
